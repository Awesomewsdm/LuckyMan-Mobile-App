...
class UserModel {
  ...
  factory UserModel.fromMap(Map<String, dynamic> map) {
    return UserModel(
      ...
      isUserBooked:
          map['isUserBooked'] != null ? map['isUserBooked'] as bool : null,
    );
  }
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, fullName: $fullName, email: $email, studentID: $studentID, phoneNumber: $phoneNumber, password: $password, isUserBooked: $isUserBooked)';
  }
