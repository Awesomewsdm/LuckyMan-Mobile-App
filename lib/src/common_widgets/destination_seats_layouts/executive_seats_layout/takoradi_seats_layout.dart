...
class TakoradiExecutiveSeatLayout extends StatelessWidget {
  final SeatSelectionController seatSelectionController =
      Get.put(SeatSelectionController());
  TakoradiExecutiveSeatLayout({Key? key, this.model}) : super(key: key);
  ...
  Widget build(BuildContext context) {
   return SeatLayoutBuilder(
      ...
      selectedSeatList: seatSelectionController.selectedTakoradiExecutiveSeats,
      amount: seatSelectionController.pTakoradiExecutiveseatPrice,
      busClass: "executive",
    );
  }
}
