...
class TemaExecutiveSeatLayout extends StatelessWidget {
  final SeatSelectionController seatSelectionController =
      Get.put(SeatSelectionController());
  TemaExecutiveSeatLayout({Key? key, this.model}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SeatLayoutBuilder(
      ...
      destination: "Tema",
      selectedSeatList: seatSelectionController.selectedTemaExecutiveSeats,
      amount: seatSelectionController.pTemaExecutiveseatPrice,
      busClass: "executive",
    );
  }
}
