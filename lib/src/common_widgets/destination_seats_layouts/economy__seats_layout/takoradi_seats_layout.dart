...
class TakoradiEconomySeatLayout extends StatelessWidget {
  ...
  TakoradiEconomySeatLayout({Key? key, this.model}) : super(key: key);
 ...
 return SeatLayoutBuilder(
      ...
      selectedSeatList: seatSelectionController.selectedTakoradiEconomySeats,
      amount: seatSelectionController.pTakoradiEconomyseatPrice,
      busClass: "economy",
    );
  }
}
